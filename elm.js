...
Elm.Main.make = function (_elm) {
   ...
   var diamond = F2(function (color,
   size) {
      return $Graphics$Collage.rotate($Basics.degrees(45))($Graphics$Collage.filled(color)($Graphics$Collage.square(size)));
   });
   var main = A3($Graphics$Collage.collage,
   200,
   200,
   _L.fromArray([A2(diamond,
   $Color.blue,
   100)]));
